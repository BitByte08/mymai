...
export const saveAchievementPlayEventLogBatch = method("saveAchievementPlayEventLogBatch"); export const getAchievementPlayEventLog = method("getAchievementPlayEventLog"); export const getDailyAchievementSummaries = method("getDailyAchievementSummaries"); export const upsertChartClears = method("upsertChartClears"); export const backfillEventRatingUp = method("backfillEventRatingUp");
